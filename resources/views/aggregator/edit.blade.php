                    ...
                    <div class="panel-body">
                        <form id="validate" role="form" class="form-horizontal" method="post" action="{{ route('aggregator.update',$aggregator)}}">                            
                            ...
                            <div class="form-group @error('name') has-error has-feedback @enderror">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="name" class="form-control" value="{{ $aggregator->name }}" />
                                </div>
                            </div>
                            <div class="form-group @error('address') has-error has-feedback @enderror">
                                <label class="col-md-3 control-label">Address:</label>
                                <div class="col-md-6">
                                <input type="text" name="address" class="form-control" value="{{ $aggregator->address }}" />
                                </div>
                            </div>
                            <div class="form-group @error('contact_person_first_name') has-error has-feedback @enderror">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="contact_person_first_name" class="form-control" value="{{ $aggregator->contact_person_first_name }}" />
                                </div>
                            </div>
                            ...
                            <div class="form-group @error('contact_person_email') has-error has-feedback @enderror">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="contact_person_email" class="form-control" value="{{ $aggregator->contact_person_email }}" />
                                </div>
                            </div>
                            <div class="form-group @error('contact_person_phone_number') has-error has-feedback @enderror">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="contact_person_phone_number" class="form-control" value="{{ $aggregator->contact_person_phone_number }}" />
                                </div>
                            </div>
                            ...
                            <div class="form-group @error('account_number') has-error has-feedback @enderror">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="account_number" value="{{$aggregator->account_number}}" />
                                </div>
                            </div>
