                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" method="post" action="{{ route('delivery.update',$delivery)}}" enctype="multipart/form-data">
                            ...
                            <div class="form-group @error('discounted_price') has-error has-feedback @enderror">
                                ...
                                <div class="col-md-6 ">
                                    <input type="text" name="discounted_price" class="form-control" value="{{ $delivery->discounted_price }}" />
                                </div>
                            </div>
                            <div class="form-group @error('number_of_bags_accepted') has-error has-feedback @enderror">
                                ...
                                <div class="col-md-6 ">
                                    <input type="text" name="number_of_bags_accepted" class="form-control" value="{{ $delivery->number_of_bags_accepted }}" />
                                </div>
                            </div>
                            <div class="form-group @error('quantity_of_bags_accepted') has-error @enderror">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="quantity_of_bags_accepted" class="form-control" value="{{ $delivery->quantity_of_bags_accepted }}" />
                                </div>
                            </div>
                            <div class="form-group @error('number_of_bags_rejected') has-error @enderror">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="number_of_bags_rejected" class="form-control" value="{{ $delivery->number_of_bags_rejected }}" />
                                </div>
                            </div>
